...
CREATE TABLE "Semester" (
  "IdSemester" nvarchar(7) primary key not null
);

CREATE TABLE "ProfessionalSchool" (
  "IdProfSchool" nvarchar(80) primary key not null,
  "Name" nvarchar(80)
);
...
CREATE TABLE "Career" (
  "IdCareer" nvarchar(80) primary key not null,
  "Name" nvarchar(80),
  "IdProfSchool" nvarchar(80),
  foreign key (IdProfSchool) references ProfessionalSchool (IdProfSchool)
);

CREATE TABLE "Course" (
  "IdCourse" nvarchar(80)  primary key not null,
  "IdCareer" nvarchar(80),
  "Name" nvarchar(80),
...
CREATE TABLE "TeacherCourse" (
  ...
  "IdTeacher" int,
  "IdSemester" nvarchar(7),
  "IdCourse" nvarchar(80),
